...
const historicalURLTemplate = "https://www.asx.com.au/asx/v2/statistics/announcements.do?by=asxCode&timeframe=D&period=M6&asxCode=%s"
...
The last 6 months of ASX announcements for %s are available at:
%s

You must access and analyze the historical announcements available at this URL to better understand any long-term trends (e.g., prior capital raises, director buying) that contextualize the current announcement:
...
Avoid generic statements and focus on the individual sub-categories I have listed, not the headings. All claims must be tied to a number, date, or specific condition.
---
